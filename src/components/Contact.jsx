...
const Contact = () => {
  ...
  return (
    <section ref={ref} id="contact" className="bg-transparent w-full min-h-screen relative overflow-hidden flex items-end pt-32 pb-0 md:pb-0 border-t border-gray-900">
